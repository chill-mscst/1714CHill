...
-- --------------------------------------------------
-- Date Created: 11/02/2020 10:57:47
-- Generated from EDMX file: C:\Users\hillc\Documents\Visual Studio\Projects\1714CHill\1714chill2f\AnimalShelterModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_AnimalTypeAnimal]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Animals] DROP CONSTRAINT [FK_AnimalTypeAnimal];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonAnimal]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Animals] DROP CONSTRAINT [FK_PersonAnimal];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonDonation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Donations] DROP CONSTRAINT [FK_PersonDonation];
GO
IF OBJECT_ID(N'[dbo].[FK_DonationTypeDonation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Donations] DROP CONSTRAINT [FK_DonationTypeDonation];
GO
...
GO
IF OBJECT_ID(N'[dbo].[DonationTypes]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DonationTypes];
GO
